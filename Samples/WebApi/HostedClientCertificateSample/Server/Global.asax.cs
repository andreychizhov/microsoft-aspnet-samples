...
namespace HostedClientCertificateSample
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        ...
        // STEP 2: Generate your own server test cert using the following makecert cmd. Please know that you must run the following command as administrator.
        ...
        // STEP 4: Go to the IIS manager, SSL setting, check require SSL and select "Allow" client certificate so that client certificate is not required
        // for anonymous access for the GET actions.

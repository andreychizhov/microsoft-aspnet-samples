<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Webforms.Samples.Account.Manage" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-horizontal">
                <section id="samplesFeatures">
                    <p>
                        <% if (HasPhoneNumber)
                           { %>
                        <asp:HyperLink NavigateUrl="/Account/AddPhoneNumber" runat="server" Text="Add a Phone Number" />
                        <%}
                           else
                           { %>
                        <span>Phone Number:
                        <asp:Label Text="" ID="PhoneNumber" runat="server" />
                            <asp:HyperLink NavigateUrl="/Account/AddPhoneNumber" runat="server" Text="[Change]" /></span> &nbsp;|&nbsp;
                    <span>
                    ...
                    <%if (TwoFactorEnabled)
                      { %>
                        <asp:LinkButton Text="[Disable]" runat="server" CommandArgument="false" OnClick="TwoFactorToggle_Click" />
                        <%}
                      else
                      { %>
                        <asp:LinkButton Text="[Enable]" CommandArgument="true" OnClick="TwoFactorToggle_Click" runat="server" />
                        <%} %>
                    </p>
                    <p>
                        Two Factor Browser Remembered?:
                    <%if (TwoFactorBrowserRemembered)
                      { %>
                        <asp:LinkButton Text="[Forget]" runat="server" ID="TwoFactorBrowserForget" OnClick="TwoFactorBrowserForget_Click" />
                        <%}
                      else
                      { %>
                        <asp:LinkButton Text="[Remember]" ID="TwoFactorBrowserRemember" OnClick="TwoFactorBrowserRemember_Click" runat="server" />
                        <%} %>
                    </p>
                </section>
                <div>
